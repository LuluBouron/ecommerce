 ...
 */
final class Version20240304134439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, name, slug, description, image_urls, is_mega, updated_at, created_at FROM category');
        $this->addSql('DROP TABLE category');
        $this->addSql('CREATE TABLE category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, image_urls VARCHAR(255) DEFAULT NULL, is_mega BOOLEAN DEFAULT NULL, updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('INSERT INTO category (id, name, slug, description, image_urls, is_mega, updated_at, created_at) SELECT id, name, slug, description, image_urls, is_mega, updated_at, created_at FROM __temp__category');
